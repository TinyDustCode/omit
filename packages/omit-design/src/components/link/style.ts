...
// import { renderPaletteColor } from "../../utils/theme-pools";
// import {
...
//   theme-pools: OmitModePaletteTypes
// ) => {
//   const { main } = renderPaletteColor({ type, mode, theme-pools });
//   return {
//     color: main,
//     "&:after": {
//       borderColor: main,
...
//   theme-pools: OmitModePaletteTypes
// ) => {
//   const { disabled } = renderPaletteColor({ type, mode, theme-pools });
//   return {
//     color: disabled,
//     "&:after": {
